<script>
  const CORRECT_PASSWORD = 'renate30';
...
<div class="password-page">
  ...
  <div class="stars">
    {#each Array(30) as _, i}
      <div class="star" style="--x:{Math.random()*100}%; --y:{Math.random()*100}%; --delay:{Math.random()*5}s; --size:{Math.random()*2+1}px;"></div>
    {/each}
  </div>

  <div class="content">
    <div class="sparkle-icon">✨</div>
    <h1>For noen spesielle</h1>
