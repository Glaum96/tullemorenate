<script>
  ...
  const persons = [
    ...
    },
    {
      ...
      imageSrc: "eivin.jpg",
      quote:
        "Gratulerer så mye med 30-års dagen🥳 Nå har jeg ikke kjent deg så lenge enda, men basert på hvor godt du har sklidd inn i gjengen med oss andre føles som jeg har kjent deg lengre enn jeg har. Du er en utrolig omtenksom, morsom og skarp person og litt kaotisk Bergens-energi er sikkert noe vi kjedelige østlendinger har veldig godt av. Det gjør meg glad å se hvor godt du og Haakon har det sammen og hvor glad du gjør han. Gleder meg videre til en nydelig Italia-tur og gleder meg til å bli bedre kjent med deg videre 😁",
      videoSrc: null,
    },
  ];
  ...
  const personsFirst = persons.slice(0, Math.ceil(persons.length / 2));
  const personsSecond = persons.slice(Math.ceil(persons.length / 2));
...
<main class="main-content">
  ...
  <section class="hero" bind:this={heroEl}>
    ...
    <div class="hero-text">
      ...
      <p class="hero-subtitle">Tre tiår med skarre-R, sol, regn, latter og kjærlighet</p>
    </div>
  </section>
  ...
  <section class="closing-section">
    <div class="closing-inner">
      ...
      <div class="closing-photo">
        <img src="/us.jpeg" alt="Haakon og Renate" />
      </div>
      <div class="closing-message">
        <p class="closing-label">Gratulerer så sinnsykt mye med 30-årsdagen, mitt favorittmenneske! Jeg føler meg så takknemmlig for å være din og å tenke på at du er min. Du er det beste som har skjedd meg. Gleder meg til å være clean boy-ork med deg i mange tiår til. Elsker deg så mye ❤️</p>
